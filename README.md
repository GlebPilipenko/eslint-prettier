...
# Remove all unused code, files, comments, folders, please get clean app, we speak about it
# on lesson...

# If you use Webstorm or PhpStorm => open setting window or ctrl + alt + s, => Editor => Code style =>
...
# Restart IDE, wait some minutes, because IDE analyzing you code and start work.
